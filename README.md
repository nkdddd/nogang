...
- **학습시간**: 할 일에 직접 적은 시간도 인정합니다. ▶ 타이머 · 포커스 타이머로 잰 시간은 그 몫에 **+10% 타이머 보너스**(부모가 % 조정, `payTerms.timerBonusRate`). 학습앱이 잰 시간은 부모가 포함/제외를 고릅니다. 하루 최대 인정(기본 4시간), 과제 1건당 계획의 3배 · 8시간 초과분은 제외.
